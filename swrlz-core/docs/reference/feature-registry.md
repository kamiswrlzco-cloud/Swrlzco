...
| Forge-side chunk transport | CLIENT Forge | CLIENT | EXPERIMENTAL | CLIENT CFv2.1.20 candidate R1; build pending | `docs/architecture/conversational-artifact-forge-and-file-organization-v1.md` | AUTO/DIRECT/CHUNKED source transport and resumable chunk planning exist in candidate lineage; not promoted authority |
