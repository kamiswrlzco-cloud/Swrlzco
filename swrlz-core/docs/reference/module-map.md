...
| `SERVER CFv2.1.25 R1 INT-AI-060A current transport` | Truth Core / reasoning / expression separation | SWRLZ CORE + SWURVER + MODEL | Centralizes non-profile truth/authority invariants and separates reasoning/output budget from profile expression | SOURCE CANDIDATE / CURRENT TRANSPORT | `docs/server/SERVER_IMPLEMENTATION_ANALYSIS.md`; `docs/patch-notes/SERVER_PATCH_NOTES.md` |
